...
const APP_VERSION: &str = __CRAPAPP_APP_VERSION__;
const REQUIRED_VARIABLES: &[&str] = &[__CRAPAPP_REQUIRED_VARIABLES__];
const UNINSTALLER_BYTES: &[u8] = include_bytes!(__CRAPAPP_UNINSTALLER_SOURCE__);
