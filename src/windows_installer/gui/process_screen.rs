...
use super::theme;
use crate::windows_installer::config::{ADD_TO_PATH_VARIABLE, InstallerConfig};
...
use crate::windows_installer::{
    create_start_menu_shortcuts, remove_associated_files, remove_created_directories,
    remove_start_menu_shortcuts, remove_user_path_entries, resolve_install_path,
};
...
impl Step {
    ...
    pub fn as_str(self) -> &'static str {
        match self {
            ...
            Self::CreatingShortcuts => "Creating shortcuts",
            ...
            Self::RemovingShortcuts => "Removing shortcuts",
