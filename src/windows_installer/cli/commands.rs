...
use crate::windows_installer::{
    add_to_path_requested, create_start_menu_shortcuts, remove_associated_files,
    remove_created_directories, remove_start_menu_shortcuts, resolve_install_path,
};
use std::borrow::Cow;
...
pub fn install(
    ...
    crate::windows_installer::install::validate_variables(config, variables)?;
